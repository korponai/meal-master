        ...
        messages: [
          {
            role: "system",
            content:
              "You are a nutrition expert assistant. Based on the provided recipe and ingredients, you calculate nutritional data. Always respond in exactly the specified JSON format. If you cannot determine a value, use null.",
          },
          {
            role: "user",
            content: prompt,
...
function generatePrompt(
  ...
  return `Calculate the nutritional data for the following recipe:
...
**IMPORTANT:** Calculate the nutritional values PER SINGLE SERVING!
...
If you cannot determine a value precisely, use null in the value field.`;
}
